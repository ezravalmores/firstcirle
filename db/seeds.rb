...
Style.create(name: "Abrianna Lightweight Knit Cardigan",
             type: "Sweater",  wholesale_price: 5, retail_price: 60).tap { |style|
...
Style.create(name: "Vicky Colorblock Trim Silk Blouse",
             type: "Top",      wholesale_price: 2.67, retail_price: 45).tap { |style|
...
Style.create(name: "Pomelo Critter Print Maxi Dress",
             type: "Dress",    wholesale_price: 4, retail_price: 80).tap { |style|
  make_items(style,"Orange")
  make_items(style,"Green")
}
Style.create(name: "Leah Straight Leg Cuffed Jean",
             type: "Pants",    wholesale_price: 10, retail_price: 90).tap { |style|
...
# So we can test pants and 5 dollar limit
Style.create(name: "Blue Camo Print Boyfriend Jeans",
             type: "Pants",    wholesale_price: 6.67, retail_price: 70).tap { |style|
  make_items(style,"Navy")
}
